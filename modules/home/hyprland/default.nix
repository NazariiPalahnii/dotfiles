    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bind = [
          ...
          "$mod,F, exec, firefox"
          "CTRL, P, exec, hyprshot -m region -r d | swappy -f -"
          "CTRL_SHIFT, P, exec, hyprshot -m window -r d | swappy -f -"
          "CTRL_ALT, P, exec, hyprshot -m output -r d | swappy -f -"
          ...
          "$mod_CTRL, G, fullscreenstate, 0 2"
          ...
          "$mod, T, exec, kitty"
          "$mod, Q, killactive,"
          "$mod, L, exec, wlogout -b 2 -L 700px -R 700px -c 50px -r 50px,"
          "$mod, E, exec, nautilus -w"
          "$mod, V, togglefloating,"
          "$mod, W, pseudo,"
          "$mod, J, togglesplit,"
          "$mod, G, exec, hyprctl dispatch fullscreen"
        ...
        exec-once = [
          ...
          "pactl load-module module-null-sink sink_name=custom_sink sink_properties=device.description='Custom_Sink'; pactl load-module module-loopback source=custom_sink.monitor sink=alsa_output.Family_17th/19h/1ah_HD_Audio_Controller.analog-stereo"
    ...
    programs.wlogout = mkIf cfg.wlogout {
      ...
      style = ''
        * {
        ...
        #sleep {
            background-image: image(url("${../../../stuff/sleep.png}"));
        }
      '';
    };
  };
